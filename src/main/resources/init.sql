...
CREATE TABLE USERS
(
    USERID BIGINT AUTO_INCREMENT NOT NULL CONSTRAINT pk_userid PRIMARY KEY,
    NAME CHAR(50) NOT NULL,
    ADDRESS VARCHAR(50),
...
CREATE TABLE ORDERS
(
    ORDERID BIGINT AUTO_INCREMENT NOT NULL CONSTRAINT pk_orderid PRIMARY KEY,
    USERID INT NOT NULL,
...
ALTER TABLE ORDER_ITEMS
    ADD CONSTRAINT pk_skuorderid Primary Key (SKU, ORDERID);
